...
from src.models.deep_model import build_gru_model
...
def train_skab_gru_fold(fold_id):
    cfg = get_dl_config()

    print("\n==============================")
    print(f"SKAB Fold {fold_id} GRU eğitimi başlıyor...")
    print("==============================")
    ...
    model = build_gru_model(input_shape=X_tr.shape[1:])
    ...
    print(f"\nSKAB Fold {fold_id} GRU En İyi Sonuç:")
...
def main():
    ...
    for fold_id in range(1, 6):
        result = train_skab_gru_fold(fold_id)
        fold_results.append(result)

    print("\n==============================")
    print("SKAB GRU FOLD SONUÇLARI")
    print("==============================")
    ...
    save_results_to_csv(
        ...
        output_path="results/outputs/skab_gru_results.csv"
    )

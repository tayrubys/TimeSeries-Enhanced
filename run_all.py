...
def main():
    ...
    print("\n=== 2. ADIM: Sequence (Zaman Penceresi) Oluşturma Başlıyor ===")
    ...
    print("\n=== 3. ADIM: ADASYN ile Veri Dengeleme Başlıyor ===")
    adasyn_path = PIPELINE_DIR / "preprocessing" / "balance_adasyn_dl.py"

    if not adasyn_path.exists():
        raise FileNotFoundError(f"Kritik Hata: 'balance_adasyn_dl.py' şu konumda bulunamadı: {adasyn_path}")
